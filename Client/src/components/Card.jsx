...
const Card = ({ title, duration, cost, level, icon, para }) => (
  ...
  >
    ...
    <button className="mt-auto bg-gradient-to-r from-purple-500 to-pink-500 text-white py-2 px-4 rounded-full hover:from-pink-500 hover:to-purple-500 transition-all duration-300">
      Enroll Now
    </button>
  </motion.div>
);
